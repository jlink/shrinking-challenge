...
func TestLargeUnionList(t *testing.T) {
	Check(t, func(t *T) {
...
func TestDifferenceNotZero(t *testing.T) {
	Check(t, func(t *T) {
...
// https://github.com/jlink/shrinking-challenge/blob/main/challenges/difference.md
func TestDifferenceNotSmall(t *testing.T) {
	Check(t, func(t *T) {
		x := IntMin(1).Draw(t, "x").(int)
		y := IntMin(1).Draw(t, "y").(int)
...
// https://github.com/jlink/shrinking-challenge/blob/main/challenges/difference.md
func TestDifferenceNotOne(t *testing.T) {
	Check(t, func(t *T) {
		x := IntMin(1).Draw(t, "x").(int)
		y := IntMin(1).Draw(t, "y").(int)
